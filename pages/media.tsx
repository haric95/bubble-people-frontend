        ...
        <div>
          <main className="bg-black relative">
            ...
            <div className="w-screen flex flex-col mt-[72px] p-8 absolute">
              <div className="mb-8">
                <>
                  <h1 className="font-title text-white mb-4 md:font-[8px]">
                    Recordings
                  </h1>
                </>
                <ReactPlayer
                  ...
                  <div className="w-full h-full flex flex-col md:flex-row items-stretch bg-white p-2">
                    ...
                    <div className="flex flex-col justify-between h-full md:ml-2 w-full">
                      ...
                      <div className="w-full">
                        <div
                          className="h-2 w-full bg-black relative cursor-pointer"
                          ref={barRef}
                          onClick={(e) => {
                            if (barRef.current) {
                              const boundingRect =
                              ...
                              const clickPercentage =
                                ...
                                boundingRect.width;
                              duration &&
                                setSeekTime(duration * clickPercentage);
              ...
              <div>
                <h1 className="font-title text-white mb-4">Performance</h1>
